...
function AdicionaUsuario({ navigation, theme }) {
    ...
    async function salvaUsuario() {
        ...
        if (Object.keys(novosErros).length > 0) {
            ...
            fetch("http://192.168.1.22:4000/usuario", requestOptions)
                .then(async response => {
    ...
    return (
        <View style={{ flex: 1, paddingVertical: 0, paddingHorizontal: 0 }}>
            ...
            <View style={{
                ...
                <Caption style={styles.titulo}>Cadastro de Usuários</Caption>
                <ScrollView>
...
export default withTheme(AdicionaUsuario)